...
abstract class J1Logger {
  ...
  static void log({required String name, Map<String, Object>? params}) {
  ...
  static void ui({required String name, required String page, Map<String, Object> params = const {}}) {
  ...
  static void bloc({required String name, required String bloc, Map<String, Object> params = const {}}) {
  ...
  static void repository({required String name, required String repository, Map<String, Object> params = const {}}) {
  ...
  void logUi({required String name, required String page, Map<String, Object> params = const {}}) {
    params["page"] = page;
    logDefault(name: "$page-page-$name", params: params);
  }

  void logBloc({required String name, required String bloc, Map<String, Object> params = const {}}) {
    params["bloc"] = bloc;
    logDefault(name: "$bloc-bloc-$name", params: params);
  }

  void logRepository({required String name, required String repository, Map<String, Object> params = const {}}) {
