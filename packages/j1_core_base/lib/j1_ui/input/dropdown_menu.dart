...
class JDropdownMenu<T> extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return DropdownMenu<T>(
      ...
      trailingIcon: trailingIcon ?? _createTrailingIcon(JamIcons.chevron_down, iconSize, foregroundColor),
      selectedTrailingIcon: selectedTrailingIcon ?? _createTrailingIcon(JamIcons.chevron_up, iconSize, foregroundColor),
      label: label,
      hintText: hintText,
