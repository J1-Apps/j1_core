...
final class TestRouteConfig extends RouteConfig {
  ...
  @override
  Map<String, Object> get pathParams => {"path0": path0, "path1": path1};

  @override
  Map<String, Object?> get queryParams => {if (query0 != null) "query0": query0, if (query1 != null) "query1": query1};

  const TestRouteConfig({required this.path0, required this.path1, this.query0, this.query1});

  static TestRouteConfig parser({required pathParams, required queryParams}) {
  ...
  group("J1 Route", () {
    ...
    test("builds a route from a config", () {
      final path = testRoute.build(
        const TestRouteConfig(path0: "testPath0Value", path1: true, query0: "testQuery0Value", query1: 10),
      );
